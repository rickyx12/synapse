...
--
-- Host: localhost    Database: Coconut
-- ------------------------------------------------------
...
INSERT INTO `SOAP` VALUES (7,218,351,'hi','ji','ki','lonnm'),(8,745,699,'testing 1','testing 2','testing 3','testing 4');
...
INSERT INTO `ipaddress` VALUES ('localhost');
...
INSERT INTO `reportHeading` VALUES (1,'hmoSOA_address','Address','Address'),(2,'hmoSOA_name','clinic name','Hospital Name'),(3,'PAN','Hospital_PAN_no','123456789'),(4,'Facility','Category of Facility','T-L4/L3'),(5,'exceededLimit','every SECONDS should update the patient profile if the patient is exceeded','3000'),(6,'anotherPrice','where to get the price rate of er and or/dr','OPD'),(7,'homeRoot','home root','/opt/lampp/htdocs');
...
-- Dump completed on 2016-10-01 20:03:09
