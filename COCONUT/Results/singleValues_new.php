...
echo "<form method='get' action='addExaminationName.php'>";
...
echo "<td><input type=text name='examName' class='txtBox' value=''></td>";
echo "</tr>";
echo "<tr>";
echo "<td><font class='labelz'>Exam Result</font></td>";
echo "<td><input type=text name='examResult' class='txtBox' value=''></td>";
echo "</tr>";
echo "<tr>";
...
echo "<td><input type=text name='examValues' class='txtBox' value=''></td>";
echo "</tr>";
echo "</tr>";
echo "</table>";
echo "<br><br>";
