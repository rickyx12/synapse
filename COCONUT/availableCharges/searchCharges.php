...
xmlhttp.open("GET","searchAvailableChargesNow.php?room="+document.addCharge.room.value+"&username="+document.addCharge.username.value+"&serverTime="+document.addCharge.serverTime.value+"&batchNo="+document.addCharge.batchNo.value+"&registrationNo="+document.addCharge.registrationNo.value+"&charges="+document.addCharge.availableCharges.value,true);
xmlhttp.send();
}
