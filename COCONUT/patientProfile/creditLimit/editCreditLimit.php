...
<?php
echo "<form method='get' action='editCreditLimit1.php'>";
...
echo "<option value='$limitTo'>$limitTo</option>";
...
echo "<option value='$limitVia'>$limitVia</option>";
...
echo "<td><input type=text name='amountLimit' value='$amountLimit' class='shortField'></td>";
echo "</tr>";
echo "</table>";
echo "<Br>	";
