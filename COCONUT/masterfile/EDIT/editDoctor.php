...
echo "
<td>
<input type=text name='acc1' maxlength=1 value='".substr($accNo[0],-4,1)."' class='panz'><input type=text name='acc2' maxlength=1 value='".substr($accNo[0],-3,1)."' class='panz1'><input type=text maxlength=1 name='acc3' value='".substr($accNo[0],-2,1)."' class='panz1'><input type=text maxlength=1 name='acc4' value='".substr($accNo[0],-1	,1)."' class='panz1'>-
