...
xmlhttp.open("GET","searchAvailableInventoryNow.php?inventoryType="+document.addCharge.inventoryType.value+"&username="+document.addCharge.username.value+"&show="+document.addCharge.show.value+"&branch="+document.addCharge.branch.value+"&description="+document.addCharge.description.value,true);
xmlhttp.send();
}
...
echo " <font size=2>Search Mode:</font> <font size=2 color=red>$inventoryType</font>";
