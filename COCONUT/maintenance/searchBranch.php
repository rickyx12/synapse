...
xmlhttp.open("GET","searchAvailableBranchNow.php?username="+document.addCharge.username.value+"&show="+document.addCharge.show.value+"&description="+document.addCharge.description.value,true);
xmlhttp.send();
}
