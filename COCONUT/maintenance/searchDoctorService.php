...
xmlhttp.open("GET","searchAvailableDoctorServiceNow.php?username="+document.addCharge.username.value+"&show="+document.addCharge.show.value+"&description="+document.addCharge.description.value,true);
xmlhttp.send();
}
...
var charges = 'Search Doctor Service';
