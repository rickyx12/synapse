...
xmlhttp.open("GET","searchAvailableChargesNow.php?username="+document.addCharge.username.value+"&show="+document.addCharge.show.value+"&title="+document.addCharge.title.value+"&description="+document.addCharge.description.value,true);
xmlhttp.send();
}
