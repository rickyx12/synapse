...
echo "<Br>";
echo "<a href='http://".$ro->getMyUrl()."/COCONUT/Cashier/mySession.php'><font color=red size=2><< Sign Out</a>&nbsp;&nbsp;&nbsp;";
echo "&nbsp;&nbsp;<a href='http://".$ro->getMyUrl()."/COCONUT/Cashier/cashierMainpage.php'><font color=blue size=2>Sign In >></font></a>";
$ro->coconutBoxStop();
