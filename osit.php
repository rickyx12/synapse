...
<head><meta charset="utf-8" /><script></script><title>Like</title><style>body{background:#fff;font-size:11px;font-family:"lucida grande",tahoma,verdana,arial,sans-serif;color:#333;line-height:1.28;margin:0;padding:0;text-align:left;direction:ltr;unicode-bidi:embed}
...
.connect_widget .connect_widget_facebook_favicon{background:url(https://s-static.ak.fbcdn.net/rsrc.php/v1/y7/r/ql9vukDCc4R.png) no-repeat -1px -47px transparent;display:block;height:14px;padding:0 0 0 0;width:14px;position:absolute;left:-1px}
...
a.connect_widget_like_button{display:block;float:left;border-radius:3px;-moz-border-radius:3px;padding:4px 5px;border:1px solid #000}
...
.thumbs_up_icon{width:15px;height:15px;margin-right:2px;background:url(https://s-static.ak.fbcdn.net/rsrc.php/v1/y7/r/ql9vukDCc4R.png) -1px -32px no-repeat}
...
table.connect_widget_button_count_summary div.thumbs_up{background:url(https://s-static.ak.fbcdn.net/rsrc.php/v1/y7/r/ql9vukDCc4R.png) no-repeat 3px -32px #eceef5;height:15px;width:18px}
td.connect_widget_simple_including div.simple_liked{background:url(https://s-static.ak.fbcdn.net/rsrc.php/v1/y7/r/ql9vukDCc4R.png) no-repeat 3px -47px #eceef5;height:15px;width:18px}
.like_button_simple .connect_widget_like_button .liketext{background:url(https://s-static.ak.fbcdn.net/rsrc.php/v1/y7/r/ql9vukDCc4R.png) no-repeat 0 -47px #eceef5}
...
.like_button_dark table.connect_widget_button_count_summary div.thumbs_up{background:transparent url(https://s-static.ak.fbcdn.net/rsrc.php/v1/y7/r/ql9vukDCc4R.png) no-repeat 3px -3px}
...
td.connect_widget_button_count_including .connect_widget_button_count_count.noGrayOut{background:transparent url(https://s-static.ak.fbcdn.net/rsrc.php/v1/yp/r/qDH1xoDhFBF.gif) no-repeat 4px 2px;padding-left:22px;padding-right:4px}
.connect_widget_rtl td.connect_widget_button_count_including .connect_widget_button_count.noGrayOut{background:transparent url(https://s-static.ak.fbcdn.net/rsrc.php/v1/yp/r/qDH1xoDhFBF.gif) no-repeat 4px 2px;padding-right:22px;padding-left:4px}
...
.connect_widget_like_button .corner{background-image:url(https://s-static.ak.fbcdn.net/rsrc.php/v1/y7/r/ql9vukDCc4R.png);height:6px;width:6px;display:block}
...
.connect_widget_like_button .liketext{background:url(https://s-static.ak.fbcdn.net/rsrc.php/v1/y7/r/ql9vukDCc4R.png) -1px -33px no-repeat;color:#3b5998;display:block;padding-left:17px;white-space:nowrap}
.connect_widget_rtl .connect_button_container .liketext{background:url(https://s-static.ak.fbcdn.net/rsrc.php/v1/y7/r/ql9vukDCc4R.png) 34px -33px no-repeat}
...
div.connect_widget_comment_box_nub{background:transparent url(https://s-static.ak.fbcdn.net/rsrc.php/v1/yn/r/vAOEfR4cWQM.gif) no-repeat 0 0;height:12px;left:-6px;position:absolute;top:6px;width:20px;z-index:3}
div.connect_widget_comment_box_upward_nub{background:transparent url(https://s-static.ak.fbcdn.net/rsrc.php/v1/yv/r/agyQHs6yLID.gif) no-repeat 0 0;height:12px;left:5px;position:absolute;top:-6px;width:20px;z-index:3}
.connect_widget_rtl div.connect_widget_comment_box_nub{background:transparent url(https://s-static.ak.fbcdn.net/rsrc.php/v1/yK/r/R95msRfVr6a.gif) no-repeat 0 0;left:-20px}
...
.connect_widget .like_button_dark .connect_widget_comment_close_button{background-image:url(https://s-static.ak.fbcdn.net/rsrc.php/v1/yE/r/htZktl244wt.png);background-repeat:no-repeat;opacity:.7}
...
.connect_widget_like_button .liketext{background:url(https://s-static.ak.fbcdn.net/rsrc.php/v1/y7/r/ql9vukDCc4R.png) -1px -33px no-repeat}
...
.like_button_like .tombstone_cross.custom_disable{background:none}
.connect_widget_like_button.like_button_like .liketextwithimage.conn{display:none}
.connect_widget_like_button.like_button_no_like .liketextwithimage.disconn{display:none}
.like_button_like .tombstone_cross img.disabled_icon{display:block}
.like_button_like .tombstone_cross:hover img.disabled_icon{display:none}
.like_button_like .tombstone_cross img.hover_icon{display:none}
.like_button_like .tombstone_cross:hover img.hover_icon{display:block}
.like_button_no_like .tombstone_cross img{height:0;margin:0;padding:0;width:0}
...
.connect_widget .tombstone_cross{background:url(https://s-static.ak.fbcdn.net/rsrc.php/v1/y7/r/ql9vukDCc4R.png) no-repeat 0 -128px;display:block;float:left;height:12px;margin-right:3px;width:14px;z-index:99}
...
.connect_widget .like_button_dark .like_button_like .tombstone_cross{background:url(https://s-static.ak.fbcdn.net/rsrc.php/v1/y7/r/ql9vukDCc4R.png) no-repeat 0 -156px}
...
.connect_widget .like_button_simple .like_button_like .tombstone_cross:hover{background-image:url(https://s-static.ak.fbcdn.net/rsrc.php/v1/y7/r/ql9vukDCc4R.png);background-position:0 -128px;cursor:auto;height:12px;margin-left:0;margin-right:3px;margin-top:0;width:14px}
...
onloadhooks=[];onloadRegister_DEPRECATED=function(a){onloadhooks.push(a);};onafterloadhooks=[];onafterloadRegister_DEPRECATED=function(a){onafterloadhooks.push(a);};document.write=function(){};var AsyncLoader=(function(){var a=document.getElementsByTagName('head')[0],b=false,c={loaded:1,complete:1},d=0,e=true,f=function(){};function g(){}function h(){d--;if(d===0)g();}function i(){if(document.readyState in c){document.detachEvent('onreadystatechange',i);f('t_domcontent');}}function j(){if(b===true&&d===0){try{k();}catch(l){}if(window._cavalry){f('t_paint');_cavalry.send();}}}function k(){ServerJSQueue.run();if(typeof _onloadHook==='function')_onloadHook();f('t_layout');f('t_onload');if(typeof _onafterloadHook==='function')_onafterloadHook();}if(window._cavalry){f=function(l){_cavalry.log(l);};}else e=false;return {load:function(l){this.loadJS(l,j);window.onload=function(){b=true;j();};if(e)if(window.addEventListener){window.addEventListener('DOMContentLoaded',function(){f('t_domcontent');},false);}else if(document.attachEvent)document.attachEvent('onreadystatechange',i);},loadCSS:function(l){var m=0,n;if(typeof l==='string')l=[l];for(;m<l.length;m++){n=document.createElement('link');n.rel='stylesheet';n.type='text/css';n.media='all';n.href=l[m];a.appendChild(n);}},loadJS:function(l,m){var n=0,o;if(typeof l==='string')l=[l];if(m)g=m;for(;n<l.length;n++){o=document.createElement('script');o.src=l[n];o.async=true;o.onload=h;o.onreadystatechange=function(){if(o.readyState in c){h();o.onreadystatechange=null;}};d++;a.appendChild(o);}},inlineCSS:function(l){var m=document.createElement('style');l=l.join('\n');m.setAttribute('type','text/css');a.appendChild(m);if(m.styleSheet){m.styleSheet.cssText=l;}else m.appendChild(document.createTextNode(l));}};})();
AsyncLoader.load(["https:\/\/s-static.ak.fbcdn.net\/rsrc.php\/v2\/yC\/r\/vNTe1LBVnbX.js"]);</script><script>ServerJSQueue.add({"require":[["lowerDomain"],["Primer"]]});</script></head><body class="plugin transparent_widget ff4 Locale_en_US"><div id="FB_HiddenContainer" style="position:absolute; top:-10000px; width:0px; height:0px;"></div><div id="LikePluginPagelet"><div id="connect_widget_4fbbe0ee77eef8022352537" class="connect_widget" style=""><table class="connect_widget_interactive_area"><tr><td class="connect_widget_vertical_center connect_widget_button_cell"><div class="connect_button_slider" style=""><div class="connect_button_container"><a class="connect_widget_like_button clearfix like_button_no_like" href="#"><div class="tombstone_cross"></div><span class="liketext">Like</span></a></div></div></td><td class="connect_widget_vertical_center"><span class="connect_widget_confirm_span hidden_elem"><a class="mrm connect_widget_confirm_link" href="#" target="_blank">Confirm</a></span></td><td class="connect_widget_vertical_center"><div class="connect_confirmation_cell connect_confirmation_cell_no_like"><div class="connect_widget_text_summary connect_text_wrapper"><span class="connect_widget_facebook_favicon"></span><span class="connect_widget_user_action connect_widget_text hidden_elem">You like this.<span class="unlike_span hidden_elem"><a class="connect_widget_unlike_link" href="#" target="_blank"></a></span><span class="connect_widget_admin_span hidden_elem">&nbsp;&middot;&nbsp;<a class="connect_widget_admin_option" href="#" target="_blank">Admin Page</a><span class="connect_widget_insights_span hidden_elem">&nbsp;&middot;&nbsp;<a class="connect_widget_insights_link" href="#" target="_blank">Insights</a></span></span><span class="connect_widget_error_span hidden_elem">&nbsp;&middot;&nbsp;<a class="connect_widget_error_text" href="#" target="_blank">Error</a></span></span><span class="connect_widget_summary connect_widget_text"><span class="connect_widget_connected_text hidden_elem"><a href="https://www.facebook.com/ricardo.osit" target="_blank">Ricardo Osit</a> likes this.</span><span class="connect_widget_not_connected_text">Be the first of your friends to like this.</span><span class="unlike_span hidden_elem"><a class="connect_widget_unlike_link" href="#" target="_blank"></a></span><span class="connect_widget_admin_span hidden_elem">&nbsp;&middot;&nbsp;<a class="connect_widget_admin_option" href="#" target="_blank">Admin Page</a><span class="connect_widget_insights_span hidden_elem">&nbsp;&middot;&nbsp;<a class="connect_widget_insights_link" href="#" target="_blank">Insights</a></span></span><span class="connect_widget_error_span hidden_elem">&nbsp;&middot;&nbsp;<a class="connect_widget_error_text" href="#" target="_blank">Error</a></span></span></div></div></td></tr></table><div class="connect_widget_sample_connections clearfix"><div class="connect_widget_sample_connection connect_widget_logged_in_user connect_widget_user_not_connected connect_widget_sample_connection connect_widget_logged_in_user connect_widget_user_not_connected"><div><a data-hover="tooltip" title="Ricardo Osit" class="name_tooltip_link" href="https://www.facebook.com/ricardo.osit" target="_blank"><img class="connect_widget_image img" src="https://fbcdn-profile-a.akamaihd.net/hprofile-ak-snc4/203104_100000270513310_7770821_q.jpg" alt="" /></a></div></div></div><div id="connect-widget-comment-box-markup"></div></div></div><script>function envFlush(a){function b(c){for(var d in a)c[d]=a[d];}if(window.requireLazy){requireLazy(['Env'],b);}else{Env=window.Env||{};b(Env);}}
envFlush({"module":"like_widget","impid":"a2343fc1","fb_dtsg":"AQAHPU3t","ajaxpipe_token":"AXgntv4WqAoVqlTC","lhsh":"xAQE_fnPZ","user":"100000270513310"});</script><script>


ServerJSQueue.add({"require":[["PlaceholderListener"],["PlaceholderOnsubmitFormListener"]]});

onloadRegister_DEPRECATED(function (){Bootloader.done([])});
onloadRegister_DEPRECATED(function (){defer_until(function() { new ExternalPageLikeWidget({"viewer":100000270513310,"channelURL":"","mobile":false,"nodeType":"link","externalURL":"","widgetID":"connect_widget_4fbbe0ee77eef8022352537","alreadyConnected":false,"viewerIsAdmin":false,"adminUrl":"","showFaces":true,"useUnlikeLink":false,"layout":"standard","locale":"en_US","commentWidgetMarkup":"","error":null,"autoResize":true,"connectText":0,"socialbar":false,"ref":null,"userOptedOut":false,"showCaptcha":false,"usingInlineCommenting":true,"isBlocked":false,"forceCommentHooks":"","isPersonalized":false,"colorScheme":null,"grayOut":true,"iframeReferer":null}); },function() { return ge("connect_widget_4fbbe0ee77eef8022352537"); })});
onloadRegister_DEPRECATED(function (){ExternalNodeConnectWidget.commentMarkup = "\u003Cdiv class=\"connect_widget_comment_box hidden_elem \">\u003Cdiv class=\"connect_widget_comment_box_upward_nub\">\u003C\/div>\u003Cdiv class=\"connect_widget_comment_area\">\u003Ctable class=\"uiGrid\" cellspacing=\"0\" cellpadding=\"0\">\u003Ctbody>\u003Ctr>\u003Ctd>\u003Cinput type=\"text\" class=\"inputtext connect_widget_comment_textinput DOMControl_placeholder\" placeholder=\"Add a comment\" value=\"Add a comment\" title=\"Add a comment\" \/>\u003C\/td>\u003Ctd>\u003Clabel class=\"connect_widget_comment_button hidden_elem uiButton uiButtonConfirm\" for=\"ubpj18_1\">\u003Cinput value=\"Post\" type=\"submit\" id=\"ubpj18_1\" \/>\u003C\/label>\u003C\/td>\u003C\/tr>\u003C\/tbody>\u003C\/table>\u003C\/div>\u003C\/div>"});
onloadRegister_DEPRECATED(function (){AsyncLoader.loadCSS("https:\/\/s-static.ak.fbcdn.net\/rsrc.php\/v2\/yp\/r\/13ZkVpXi96a.css");});
